...
{   
	...
	std::cout << "time cost: " << duration_cast<duration<double>>(dur).count() << "s" << std::endl;
}
...
int	main (int argc, char ** argv)
{
	...
	rnd.seed(high_resolution_clock::now().time_since_epoch().count());
	...
	while(true){
		...
		std::cout << (firsttime ? " ------- input your message: ------- " : 
			" ------- input your next message: ------- ") << std::endl;;
		...
		for(auto i : message_number) std::cout << i << std::endl;
		std::cout << std::endl;
		...
		for(auto i : encrypted_message_number) std::cout << i << std::endl;
		toc();
		std::cout << std::endl;
		...
		for(auto i : decrypted_message_number) std::cout << i << std::endl;
		toc();
		std::cout << std::endl;
